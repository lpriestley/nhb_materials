...
% x_t=s_t+e_t
% s_t=a*s_t-1+n_t
% N=7; T=180; order=3; [x, ars, sarx, sary, sarz] = generate_latent_ar(N,N,1,T, [0.2 0.1 0], 0.1, 0.1, 0, 100, 1000, 0, 0); save_avw(x,'/usr/people/woolrich/bpm/data/art_ar3_small','s',[4 4 7 3]); save_avw(arcoeff,'/usr/people/woolrich/bpm/data/arcoeff_ar3','s',[4 4 7 3]); 
