function out = roiVF(Data,Mean,func,funcd,varargin)
...
%
% out = roiVF(Data,Mean,func,funcd,varargin)
%
...
if nargin<2 Mean = 'm'; end
if nargin<3 func = 'roiplotseries'; end
if nargin<4 funcd = 'side'; end
...
while 1==1
    ...
    if gca==LeftImg
        ...
        if drawflag
            ...
            redrawRightImg(MeanImg,ImgNum,Index,Xrange,Yrange,mask,maskColor,noMaskColors,maskNo)
...
%%%%%%%%%%%%%%%%%%%%%%
function redrawRightImg(MeanImg,ImgNum,Index,Xrange,Yrange,mask,maskColor,noMaskColors,maskNo)
    RightImg=subplot('position',[0.37,0.41,0.4,0.55]);
    DisplayImg = Intense2rgb(MeanImg(:,:,ImgNum)');
    for j = 1:noMaskColors
        [y,x] = find(mask(:,:,ImgNum+Index,j));
